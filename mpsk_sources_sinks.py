...
# Generated: Wed Mar 14 17:32:46 2018
##################################################
...
class sources_and_sinks(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Sources And Sinks")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Sources And Sinks")
        ...
        self.settings = Qt.QSettings("GNU Radio", "sources_and_sinks")
        ...
        # Blocks
        ##################################################
        self._noise_amp_range = Range(0, 1, 0.01, 1, 200)
...
def main(top_block_cls=sources_and_sinks, options=None):
